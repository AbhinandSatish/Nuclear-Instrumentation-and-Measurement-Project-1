...
The full report can be seen in the document [NIM Project 1 Report.pdf](./NIM%20Project%201%20Report.pdf). The code can be found in the Jupyter Notebook file [project1 (1).ipynb](./project1.ipynb). 
